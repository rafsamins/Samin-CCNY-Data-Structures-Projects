...
// This file will be commented out because in one project, you can only have one
// file containing main function. So I should have either statexam or stattest
// but not both
